<div class="form-group {!! !$errors->has($label) ?: 'has-error' !!}">
    ...
    <div class="{{$viewClass['field']}}">
        ...
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal-code" style="margin-right: 20px;">获取恢复秘钥</button>
        ...
        <button type="button" style="display: none" class="btn btn-success" id="open-secret" data-toggle="modal" data-target="#myModal">开启二次验证</button>
